...
export const tenantSections: NavSection[] = [
  ...
  { label: 'Sales', icon: 'orders', pages: [{ label: 'Orders', path: '/orders' }, { label: 'Counter', path: '/counter' }, { label: 'Tables', path: '/tables', capability: 'qr_table_ordering' }, { label: 'Refunds', path: '/refunds' }] },
