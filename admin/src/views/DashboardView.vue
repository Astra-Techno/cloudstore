...
.dashboard-kicker, .panel-kicker { margin: 0 0 9px; color: #e06e57; font-size: 10px; font-weight: 900; letter-spacing: 1.5px; text-transform: uppercase; }
.dashboard-intro h1 { margin: 0; color: #17221f; font-size: clamp(26px, 3vw, 40px); line-height: 1.06; letter-spacing: -1.8px; }
.dashboard-subtitle { margin: 10px 0 0; color: #718078; font-size: 13px; }
.dashboard-action { display: inline-flex; align-items: center; gap: 14px; padding: 12px 16px; border: 1px solid #cfdbd3; border-radius: 11px; color: #17221f; background: #fff; font-size: 12px; font-weight: 800; text-decoration: none; box-shadow: 0 6px 18px rgba(38,59,47,.04); transition: .2s ease; }
.dashboard-action:hover { border-color: #a8c83d; transform: translateY(-2px); }
.metric-grid { display: grid; grid-template-columns: 1.45fr repeat(3, 1fr); gap: 14px; margin-bottom: 26px; }
.metric-card { min-height: 164px; padding: 20px; border: 1px solid #dfe7e1; border-radius: 16px; background: #fff; box-shadow: 0 8px 24px rgba(38,59,47,.035); }
.metric-card--dark { position: relative; overflow: hidden; border-color: #17221f; color: #f5f8ee; background: #17221f; }
.metric-card__top { display: flex; align-items: center; justify-content: space-between; color: #6c7b73; font-size: 11px; font-weight: 800; }
.metric-card--dark .metric-card__top { color: #a4b2aa; }
.metric-card strong { display: block; margin-top: 20px; color: #17221f; font-size: 32px; letter-spacing: -1.5px; }
.metric-card--dark strong { color: #f5f8ee; }
.metric-card p { margin: 8px 0 0; color: #93a099; font-size: 11px; }
.metric-card--dark p { color: #a4b2aa; }
.metric-icon { display: grid; width: 27px; height: 27px; place-items: center; border-radius: 9px; color: #17221f; background: #eaf4c0; font-size: 14px; font-weight: 900; }
.metric-icon--coral { color: #a64f3e; background: #fce3dc; }.metric-icon--lime { color: #677d1e; background: #e8f6a7; }.metric-icon--blue { color: #386a71; background: #d9eef0; }
.metric-trend { color: #d9f36d; font-weight: 900; }.metric-wave { position: absolute; right: 18px; bottom: 0; display: flex; align-items: flex-end; gap: 5px; height: 48px; opacity: .7; }.metric-wave i { display: block; width: 5px; border-radius: 5px 5px 0 0; background: #d9f36d; }.metric-wave i:nth-child(1) { height: 18px; }.metric-wave i:nth-child(2) { height: 28px; }.metric-wave i:nth-child(3) { height: 21px; }.metric-wave i:nth-child(4) { height: 39px; }.metric-wave i:nth-child(5) { height: 30px; }.metric-wave i:nth-child(6) { height: 44px; }.metric-wave i:nth-child(7) { height: 35px; }
.dashboard-columns { display: grid; grid-template-columns: 1.25fr .75fr; gap: 14px; }
.panel { min-height: 340px; padding: 25px; border: 1px solid #dfe7e1; border-radius: 16px; background: #fff; box-shadow: 0 8px 24px rgba(38,59,47,.035); }.panel-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; }.panel-kicker { margin-bottom: 6px; color: #8b9992; }.panel h2 { margin: 0; color: #17221f; font-size: 18px; letter-spacing: -.5px; }.panel-count { padding: 7px 10px; border-radius: 20px; color: #62716a; background: #f0f4ef; font-size: 10px; font-weight: 800; }.spark-mark { color: #a8c83d; font-size: 22px; }
.pulse-content { display: flex; align-items: center; gap: 34px; padding: 42px 12px 16px; }.pulse-ring { display: flex; width: 150px; height: 150px; flex: 0 0 150px; flex-direction: column; align-items: center; justify-content: center; border: 13px solid #e8f3ad; border-right-color: #d9f36d; border-bottom-color: #f0785f; border-radius: 50%; }.pulse-ring strong { color: #17221f; font-size: 34px; letter-spacing: -1px; }.pulse-ring span { color: #84928b; font-size: 10px; line-height: 1.3; text-align: center; text-transform: uppercase; }.pulse-list { display: grid; flex: 1; gap: 18px; }.pulse-label { display: flex; align-items: center; gap: 8px; color: #617069; font-size: 11px; text-transform: capitalize; }.pulse-label strong { margin-left: auto; color: #17221f; }.status-dot { width: 8px; height: 8px; border-radius: 50%; background: #bbc6bf; }.status-dot--amber { background: #e9ae57; }.status-dot--blue { background: #6eabb4; }.status-dot--lime { background: #a8c83d; }.status-dot--coral { background: #f0785f; }.pulse-bar { height: 5px; margin-top: 8px; overflow: hidden; border-radius: 5px; background: #edf1ed; }.pulse-bar i { display: block; height: 100%; border-radius: inherit; background: #d9f36d; }
/* Chart styles */
...
.chart-bar { width: 100%; max-width: 48px; background: linear-gradient(180deg, #d9f36d, #a8c83d); border-radius: 6px 6px 0 0; transition: height .4s ease; }
.chart-bar-value { color: #17221f; font-size: 10px; font-weight: 800; }
.chart-bar-label { color: #617069; font-size: 10px; font-weight: 700; text-transform: uppercase; }
.chart-bar-orders { color: #93a099; font-size: 9px; }
/* Top products */
...
.top-product-item:hover { background: #f4f7ef; }
.top-product-rank { display: grid; width: 26px; height: 26px; place-items: center; border-radius: 8px; background: #edf1ed; color: #617069; font-size: 11px; font-weight: 900; }
.top-product-item strong { display: block; font-size: 12px; color: #17221f; }
.top-product-item small { display: block; margin-top: 2px; color: #8a9891; font-size: 10px; }
.top-product-revenue { color: #17221f; font-size: 12px; font-weight: 800; }
.shortcut-list { display: grid; gap: 9px; margin-top: 25px; }.shortcut-item { display: flex; align-items: center; gap: 12px; padding: 12px 10px; border-radius: 12px; color: #17221f; text-decoration: none; transition: .2s ease; }.shortcut-item:hover { background: #f4f7ef; transform: translateX(3px); }.shortcut-icon { display: grid; width: 34px; height: 34px; place-items: center; border-radius: 10px; font-size: 18px; font-weight: 700; }.shortcut-icon--orders { color: #a64f3e; background: #fce3dc; }.shortcut-icon--products { color: #677d1e; background: #e8f6a7; }.shortcut-icon--categories { color: #386a71; background: #d9eef0; }.shortcut-item span:nth-child(2) { flex: 1; }.shortcut-item strong, .shortcut-item small { display: block; }.shortcut-item strong { font-size: 12px; }.shortcut-item small { margin-top: 4px; color: #8a9891; font-size: 10px; }.shortcut-item b { color: #9aa8a1; font-size: 16px; }.empty-state { display: flex; min-height: 230px; flex-direction: column; align-items: center; justify-content: center; color: #85938c; text-align: center; }.empty-state span { color: #a8c83d; font-size: 28px; }.empty-state p { margin: 10px 0 4px; color: #53635d; font-size: 13px; font-weight: 800; }.empty-state small { font-size: 11px; }.dashboard-loading { display: grid; grid-template-columns: repeat(4, 1fr); gap: 14px; }.loading-block { height: 164px; border-radius: 16px; background: linear-gradient(100deg, #e8eee9 30%, #f6f8f5 50%, #e8eee9 70%); background-size: 200% 100%; animation: loading-shimmer 1.3s infinite; }.dashboard-error { display: grid; gap: 7px; padding: 26px; border: 1px solid #f1c3b8; border-radius: 16px; color: #9a5547; background: #fff5f2; font-size: 13px; }.dashboard-error span { color: #b17b70; font-size: 11px; }
